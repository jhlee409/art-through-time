...
$('#techniques-button').onclick = () => window.open(uHangulModeUrl('techniques.html'), 'artThroughTimeTechniques');
$('#topics-button').onclick = () => window.open(uHangulModeUrl('topics.html'), 'artThroughTimeTopics');
