...
const { artistSearchCandidates, normalizeArtistWorks, artworkInfo, getJsonFast, api, similarityScore, getEntities, entityId, entityYear, entityLabel, koreanArtistNameOverrides, saveThumbnailBuffer, saveThumbnailFromLocalUpload, readArtistsFile, readArtistsIndex, readArtistDetail, writeArtistsFile, updateArtistPresentation, updateArtistSummaryFromLinks, highResolutionPathExists, thumbnailLocation, makePngUnderStorageLimit } = artistData;
